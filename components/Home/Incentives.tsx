        ...
        <div className="mx-auto max-w-2xl px-4 lg:max-w-none">
          <div className="grid grid-cols-1 items-center gap-x-16 gap-y-10 lg:grid-cols-2">
            ...
            <Image
              ...
              width={500}
              alt=""
              src="https://images.unsplash.com/photo-1513726214296-1f2e95e452d8?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NzN8fHBha2FnaW5nfGVufDB8MHwwfHx8MA%3D%3D"
            ...
            {incentives.map((incentive) => (
              <div key={incentive.name} className="sm:flex lg:block">
                <div className="sm:shrink-0">
                  <Image height={100} width={100} alt="" src={incentive.imageSrc} className="size-16" />
                </div>
